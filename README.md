...
2. Run the sync script to regenerate the static catalog and cache images in `public/images/printify`:
   ...
   > The EDM Shuffle sync only persists products that are both visible and published (have an external Printify ID), and trims the catalog to the seven most recently updated products so the site always reflects live storefront merch.
