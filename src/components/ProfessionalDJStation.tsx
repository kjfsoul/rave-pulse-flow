...
const ProfessionalDJStation: React.FC = () => {
  ...
  // Handle "Start Engine" button click
  const handleStartEngine = async () => {
    try {
      ...
      setAudioContext(context);
        ...
        // Load demo tracks (pass context directly)
        await loadDemoTracks(context);
  ...
  const loadDemoTracks = async (ctx: AudioContext) => {
    if (!ctx) {
      console.warn('Cannot load demo tracks: AudioContext is null');
      return;
    }
  ...
  // Show "Start Engine" overlay if audio context is not initialized or suspended
  if (!audioContext || audioContext.state === 'suspended') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 flex items-center justify-center">
        <Card className="bg-gray-900/80 border-purple-500/30 backdrop-blur-lg max-w-md mx-auto">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-purple-300 mb-6">
              Click the button below to start the audio engine. This is required by your browser's autoplay policy.
            </p>
            <Button
              onClick={handleStartEngine}
              size="lg"
              className="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white font-semibold px-8 py-6 text-lg"
            >
  ...
  if (!isInitialized) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 flex items-center justify-center">
        <Card className="bg-gray-900/80 border-purple-500/30 backdrop-blur-lg">
          <CardContent className="p-8 text-center">
