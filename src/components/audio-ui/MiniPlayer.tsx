...
// Mock tracks for demo - replace with your actual track data
const mockTracks = [
        ...
        <div className="bg-bass-medium/70 backdrop-blur-md border-t border-neon-purple/30 md:border md:border-neon-purple/30 rounded-t-lg md:rounded-lg p-4 relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <motion.button
              ...
              className="bg-neon-purple hover:bg-neon-purple/80 p-2 rounded-full transition-colors"
            ...
            {/* BPM Badge */}
            <div className="bg-neon-cyan/20 text-neon-cyan px-2 py-1 rounded text-xs font-mono">
              {bpm} BPM
            </div>
          ...
          {/* Progress Bar */}
          <div 
            className="w-full h-1 bg-slate-600 rounded-full cursor-pointer"
            onClick={handleSeek}
          >
            <motion.div
