...
export const useAudioPlayer = (audioSrc: string = '/audio/festival_mix.mp3'): AudioPlayerHook => {
  ...
  useEffect(() => {
    ...
    // Fallback: Create silent audio buffer if file doesn't exist
    audio.addEventListener('error', () => {
      console.log('Audio file not found, using silent buffer');
      // Create a minimal silent audio buffer for development
