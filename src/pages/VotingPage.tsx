    ...
    <Layout title="Festival Voting">
      <div className="min-h-screen bg-bass-dark relative pb-20">
        ...
        <main className="relative z-10 max-w-4xl mx-auto px-4 py-8">
          ...
          <HeadlinerAnnouncement threshold={500} celebrationDuration={8000} />
          ...
          >
            ...
            <div className="relative container mx-auto px-4 py-8">
              <div className="text-center space-y-4">
                ...
                >
                  Vote for your favorite artists to help determine who becomes
                  the festival headliner! Your votes matter and will be
                  reflected in real-time on the leaderboard.
                </motion.p>
              </div>
            </div>
          </motion.header>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-4 bg-gray-700/30 rounded-lg">
                      <div
                        className={`text-2xl font-bold ${
                          canVote ? "text-purple-400" : "text-orange-400"
                        }`}
                      >
            ...
            >
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-start space-x-2">
                      ...
                      <span>
                        Each user gets 1 vote per minute with a maximum weight
                        of 10
                      </span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0" />
                      <span>
                        Higher weight votes have more impact on the leaderboard
                      </span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0" />
                      <span>
                        The artist with the highest total weight becomes the
                        headliner
                      </span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0" />
                      <span>
                        Leaderboard updates in real-time as votes are cast
                      </span>
                    </div>
                  </div>
                </CardContent>
              ...
              <div className="space-y-4">
                ...
                <LiveLeaderboard limit={10} showControls={false} />
              </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm">
                        Vote strategically - save your high-weight votes for
                        your top choices
                      </span>
                    </div>
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm">
                        Encourage friends to vote for artists you want to see
                      </span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Clock className="w-4 h-4 text-green-400" />
                      <span className="text-sm">
                        Vote regularly to maximize your impact
                      </span>
                    </div>
                  </div>
                </CardContent>
        ...
        {/* Add BottomNavigation if not already present, or remove if Layout handles it */}
      </div>
    </Layout>
  );
};
