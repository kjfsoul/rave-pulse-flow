        ...
        <main className="relative z-10 max-w-4xl mx-auto px-4 py-8">
          ...
          >
            ...
            <p className="text-slate-300 leading-relaxed">
              EDM Shuffle is your ultimate platform for tracking dance journeys,
              preparing for festivals, and connecting with the global electronic
              music community. We are committed to protecting your privacy while
              providing an electrifying experience that celebrates creativity,
              movement, and music.
            </p>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2 text-slate-300">
                <span className="text-neon-purple mt-1">•</span>
                <span>
                  <strong className="text-white">Age 18+:</strong> Platform
              ...
              <li className="flex items-start gap-2 text-slate-300">
                <span className="text-neon-purple mt-1">•</span>
                <span>
                  <strong className="text-white">NSFW Content:</strong> Some
              ...
              <li className="flex items-start gap-2 text-slate-300">
                <span className="text-neon-purple mt-1">•</span>
                <span>
                  <strong className="text-white">Content Filters:</strong>{" "}
                  Customizable visibility settings available
                </span>
              </li>
              <li className="flex items-start gap-2 text-slate-300">
                <span className="text-neon-purple mt-1">•</span>
                <span>
                  ...
                  Family sharing options for younger users
                </span>
              </li>
            </ul>
          </motion.section>
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2 text-slate-300">
                    ...
                    <span>
                      ...
                      privacy@edmshuffle.com
                    </span>
                  </li>
                  <li className="flex items-start gap-2 text-slate-300">
                    <span className="text-neon-purple mt-1">•</span>
                    <span>
                      <strong className="text-white">In-App:</strong> Settings →
                      Privacy → Contact Us
                    </span>
                  </li>
                  <li className="flex items-start gap-2 text-slate-300">
                    ...
                    <span>
                      ...
                      Within 48 hours for urgent privacy concerns
                    </span>
                  </li>
                </ul>
              </div>
          ...
          >
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              ...
              We're committed to protecting your personal information while
              providing the tools and community you need to express yourself
